The following is stale, where the files located in the ZIP folder are the matured and cured version of each of their labelled branches.  Check out also the TempleOS files as relates.
...
All files remain property of ZCHG.org pursuant but not limited to attached licensing and readme.
